...
from marketplace.views import job_list, job_details, apply_for_job, post_job, manage_posted_jobs, pick_candidate, \
    select_candidate, dev_pool, dev_details, process_payment, payment_canceled, flutterwavepayment_done
...
urlpatterns = [
    ...
    path('flutterdone/', flutterwavepayment_done, name='flutter-done'),
]
